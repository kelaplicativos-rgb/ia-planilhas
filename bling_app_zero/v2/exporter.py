...
def run_export_clean(payload: TablePayload) -> ModuleResult:
    ...
    return ModuleResult(
        ...
        message='Exportação final compartilhada aplicada.',
...
EXPORT_CLEAN_SPEC = ModuleSpec(
    ...
    description='Usa o exportador final compartilhado para limpar textos, remover colunas internas e gerar CSV padrão Bling.',
    operation='global',
    stage='export',
    version='2.1.0',
