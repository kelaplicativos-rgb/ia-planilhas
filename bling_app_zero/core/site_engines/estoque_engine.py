...
def executar_site_estoque_engine(
    ...
    *,
    ...
    if progress_callback:
        progress_callback(1, "Estoque: lendo paginas de produto", 1)
    ...
    if progress_callback:
        progress_callback(85, "Estoque: montando resultado nas colunas do modelo", 1)
    ...
    if progress_callback:
        progress_callback(100, "Estoque: finalizado", 1)
