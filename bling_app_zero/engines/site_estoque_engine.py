...
RESPONSIBLE_FILE = 'bling_app_zero/engines/site_estoque_engine.py'
...
def run_engine(*args, **kwargs) -> pd.DataFrame:
    return run_site_estoque_engine(*args, **kwargs)


__all__ = ['RESPONSIBLE_FILE', 'run_engine', 'run_site_estoque_engine']
