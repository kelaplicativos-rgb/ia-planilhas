...
def build_super_mapping(df_source: pd.DataFrame, model: pd.DataFrame, source_columns: list[str]) -> dict[str, str]:
    """Gera sugestão inicial local e segura para o mapeamento manual.

    A IA Real não roda aqui. Ela fica somente na etapa posterior "IA / Revisão",
    depois que o usuário confirma o mapeamento.
    """
