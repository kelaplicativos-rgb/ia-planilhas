...
_PATCH_ATTR = '_download_estoque_runtime_fix_v1'
...
def install_download_estoque_runtime_fix() -> bool:
    ...
    add_audit_event(
        'download_estoque_runtime_fix_installed',
        area='DOWNLOAD',
        status='OK',
        details={'target': 'home_download._operation_contract_mismatch_error', 'responsible_file': RESPONSIBLE_FILE},
    )
    return True
