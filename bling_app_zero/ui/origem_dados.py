...
def render_origem_dados() -> None:
    ...
    # CORREÇÃO:
    # A precificação precisa usar a planilha de origem para escolher e calcular
    # a coluna de custo, e o próprio módulo já grava o resultado no df_saida real do fluxo.
