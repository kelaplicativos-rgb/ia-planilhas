...
def _obter_origem_atual() -> str:
    try:
        return str(st.session_state.get("origem_dados") or "").strip().lower()
    except Exception:
        return ""
...
def render_origem_dados() -> None:
    ...
    # 🔥 BOTÃO VOLTAR SEMPRE QUE NÃO ESTIVER NA ORIGEM
    if etapa != "origem":
    ...
    try:
        ...
        log_debug(f"Erro sincronizando origem: {e}", "ERROR")
