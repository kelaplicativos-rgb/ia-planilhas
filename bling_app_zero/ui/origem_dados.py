...
def _render_operacao_clickable() -> str:
    ...
    st.markdown('<div class="od-choice-label">Toque em uma opção:</div>', unsafe_allow_html=True)
...
def render_origem_dados(
    ...
    operacao = _render_operacao_clickable()
    ...
    _render_question_block(
        ...
        "Toque em uma origem grande e depois carregue a base.",
    )
