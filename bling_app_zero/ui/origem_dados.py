...
def _gerar_sugestoes_mapeamento(
    ...
    for coluna_origem in df_origem.columns:
        slug = _normalizar_nome_coluna(coluna_origem)
...
def render_origem_dados() -> None:
    ...
    try:
        _ = sugestao_automatica(df_origem, colunas_modelo_ativas)
    except Exception:
        pass
    ...
    def validar_saida_bling(
        ...
        if modo_atual == "estoque":
            ...
            if coluna_deposito and not str(st.session_state.get("deposito_nome", "")).strip():
