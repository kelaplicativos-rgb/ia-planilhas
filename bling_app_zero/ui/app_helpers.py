...
def render_preview_final() -> None:
    ...
    # Congela o DF usado no download desta renderização
    ...
    if not valido:
        ...
        log_debug(
            f"Campos obrigatórios faltando: {texto_campos if texto_campos else 'não identificado'}",
            "ERROR",
        )
    else:
    ...
    # Renderiza apenas o painel; não repetir subheader aqui,
    # pois o próprio painel pode já exibir o título.
    render_bling_panel()
