...
def _render_preview_final() -> None:
    ...
    st.markdown("#### Preview final pronto para seguir no fluxo")
...
def _executar_fluxo(comando: str, upload_arquivo=None) -> None:
    ...
    if resultado.get("validacao", {}).get("aprovado"):
        _sincronizar_etapa("final")
    else:
        _sincronizar_etapa("mapeamento")
...
def render_ia_panel() -> None:
    ...
    st.caption(
        ...
        "A IA interpreta, busca os dados, valida e prepara a base do Bling."
    )
